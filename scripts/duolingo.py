...
def get_duolingo_data():
    ...
    print(f"duolingo_id = {duolingo_id}")
    r = requests.get(
        f"https://ios-api-2.duolingo.com/2017-06-30/users/{duolingo_id}/xp_summaries?endDate={end}&startDate={start}&timezone=Asia/Shanghai",
        headers=headers,
    )
    if r.ok:
        workout = {}
